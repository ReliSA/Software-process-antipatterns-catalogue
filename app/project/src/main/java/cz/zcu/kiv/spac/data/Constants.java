...
public class Constants {
    ...
    public static final String RESOURCE_LABELS_MANAGER_WINDOW = "/windows/LabelsManagerWindow.fxml";
    public static final String RESOURCE_NEW_LABEL_WINDOW = "/windows/NewLabelWindow.fxml";
    public static final String RESOURCE_GRAPH_GENERATOR_WINDOW = "/windows/DotGraphGeneratorWindow.fxml";
